<x-layout>
    ...
    <div class="grid max-w-screen-md px-4 py-8 mx-5 lg:gap-8 xl:gap-0 lg:py-16 lg:grid-cols-12">
        <div class="pb-5 lg:mt-0 lg:col-span-5 lg:flex">
        ...
        <div class="mr-auto px-10 place-self-center lg:col-span-7">
            ...
            <p class="max-w-2xl mb-6 font-light text-gray-500 lg:mb-8 md:text-lg lg:text-xl dark:text-gray-400">{{ auth()->user()->username }} | {{ auth()->user()->email }}</p>
