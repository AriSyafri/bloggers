<x-layout>
    ...
    <div class="mx-auto max-w-screen-xl px-4 2xl:px-0">
        ...
        <div class="grid gap-4 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4">
            ...
            <a href="/posts?category={{ $category->slug }}" class="flex items-center rounded-lg border border-gray-200 bg-white px-4 py-2 hover:bg-gray-50 dark:border-gray-700 dark:bg-gray-800 dark:hover:bg-gray-700">
