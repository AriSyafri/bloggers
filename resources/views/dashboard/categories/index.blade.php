                ...
                <form action="/dashboard/categories" method="GET">
                    <div class="items-center mx-auto mb-2 space-y-4 max-w-screen-sm sm:flex sm:space-y-0">
                        <div class="relative w-full">
                            ...
                            <input
                                class="block p-2 pl-10 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 sm:rounded-none sm:rounded-l-lg focus:ring-primary-500 focus:border-primary-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                                placeholder="Insert category..." type="search" id="search" name="search"
                                autocomplete="off">
                        </div>
                        <div>
                            <button type="submit"
                        ...
                        @foreach($categories as $category)
                            <tr class="border-b dark:border-gray-700">
                                ...
                                <td class="px-4 py-3 text-center">
                                    ...
                                    <a href="/dashboard/categories/{{ $category->slug }}/edit" class="text-white bg-green-700 hover:bg-green-800 focus:ring-4 focus:ring-green-300 font-medium rounded-lg text-sm px-4 lg:px-5 py-2 lg:py-2.5 mr-2 dark:bg-green-600 dark:hover:bg-green-700 focus:outline-none dark:focus:ring-green-800">Edit</a>
