...
<div class="min-h-screen w-full flex flex-col justify-start items-start bg-gray-100 dark:bg-gray-900 px-4">
    <div class="w-full max-w-5xl mx-auto py-2 px-6 md:px-12">
        <h2 class="mb-2 text-2xl tracking-tight font-bold text-gray-900 dark:text-white">Edit Post</h2>
        <form method="post" action="/dashboard/posts/{{ $post->slug }}" class="w-full">
            @method('put')
            @csrf
            <div class="mb-3">
                ...
                <input type="text" id="title" name="title"
                    ...
                    placeholder="your title" required autofocus value="{{ old('title', $post->title) }}">
                    @error('title')
            ...
            <div class="mb-3">
                ...
                <input type="text" id="slug" name="slug"
                    ...
                    placeholder="your slug" required value="{{ old('slug', $post->slug) }}">
            </div>
