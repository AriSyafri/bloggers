        ...
        <ul class="space-y-2">
            ...
            <li>
                <a href="/dashboard/posts"
                    class="{{ Request::is('dashboard/posts*') ? 'bg-gray-100 dark:bg-gray-700 text-gray-900 dark:text-white' : 'text-gray-900 dark:text-white' }} flex items-center p-2 text-base font-medium rounded-lg transition duration-75 hover:bg-gray-100 dark:hover:bg-gray-700 group">
